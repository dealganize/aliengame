<template>
	<div id="app" class="contain">
		<GamestateStart v-if="uiState === 'start'">
			...
			<button @click="pickCharacter">Choose</button>
		</GamestateStart>
		...
		<section v-else-if="uiState === 'characterChosen'">
			<svg viewBox="0 -180 1628 1180" class="main">
				...
				<component :is="characterInput" class="character-clip"></component>
			...
			<div class="zombietalk">
				<p v-for="option in shuffle(characterChoices)" :key="option">
					<button @click="pickQuestion(option)">
		...
		<GamestateFinish v-if="uiState === ''"></GamestateFinish>
	</div>
</template>
